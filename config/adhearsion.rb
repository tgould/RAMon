...
Adhearsion.config do |config|
  ...
  config.punchblock.username = "ramon" # Your AMI username
  config.punchblock.password = "r@m0n" # Your AMI password
  config.punchblock.host = "127.0.0.1" # Your AMI host

  config.platform.process_name = "ramon"
  ##
  # Use with FreeSWITCH
  #
...
Adhearsion.router do
  ...
  #
  route 'adhearsion context', Ramon, agi_context: 'adhearsion'
  #route 'public context', MyMenu, agi_context: 'public'
end